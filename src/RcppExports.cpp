...
// g_transform
std::string g_transform(std::string geom, std::string srs_from, std::string srs_to, bool wrap_date_line, int date_line_offset);
...
// srs_find_epsg
SEXP srs_find_epsg(std::string srs, bool all_matches);
