...
Information about format specific creation options can be obtained with the function `getCreationOptions()`. This function lists all  options for the format by default, or output can be filtered to specific options:
