...
## Display using base R graphics

`plot_raster()` displays raster data that has been read into a vector. It supports single-band grayscale, 3-band RGB, and options for user-supplied color table or color mapping function. For example, a user-defined palette can be used to generate a color ramp:
