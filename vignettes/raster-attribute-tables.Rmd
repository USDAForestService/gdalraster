...
The function `displayRAT()` generates a presentation table. Colors are shown if the RAT contains RGB columns. `displayRAT()` returns an object of class `gt::gt_tbl` (which could be modified if desired using functions of the **gt** package):
