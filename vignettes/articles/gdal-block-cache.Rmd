...
Tests were run on a Dell XPS 13 laptop with Intel(R) Core(TM) i5-8250U CPU @ 1.60GHz, 8 GB RAM and SSD, Ubuntu 22.04.2, R 4.3.0, gdalraster 1.2.1 (dev), GDAL 3.6.2.
...
get_cache_used()  # amount of memory currently in use for cache (MB)
#> [1] 0

## Reading 24 rows spaced by one half the tile height
## Every other row-level read() intersects a new set of 1222 tiles
## Default cache size is approximately 400 MB in this case (5% of 8 GB RAM)
for (n in 0:23) {
  r = ds$read(1, 0, (n * 64), ncols, 1, ncols, 1)
  print( paste("Row number read:", (n * 64)) )
  print( paste("Cache memory in use (MB):", get_cache_used()) )
}
#> [1] "Row number read: 0"
#> [1] "Cache memory in use (MB): 40"
#> [1] "Row number read: 64"
#> [1] "Cache memory in use (MB): 40"
#> [1] "Row number read: 128"
#> [1] "Cache memory in use (MB): 80"
#> [1] "Row number read: 192"
#> [1] "Cache memory in use (MB): 80"
#> [1] "Row number read: 256"
#> [1] "Cache memory in use (MB): 120"
#> [1] "Row number read: 320"
#> [1] "Cache memory in use (MB): 120"
#> [1] "Row number read: 384"
#> [1] "Cache memory in use (MB): 160"
#> [1] "Row number read: 448"
#> [1] "Cache memory in use (MB): 160"
#> [1] "Row number read: 512"
#> [1] "Cache memory in use (MB): 201"
#> [1] "Row number read: 576"
#> [1] "Cache memory in use (MB): 201"
#> [1] "Row number read: 640"
#> [1] "Cache memory in use (MB): 241"
#> [1] "Row number read: 704"
#> [1] "Cache memory in use (MB): 241"
#> [1] "Row number read: 768"
#> [1] "Cache memory in use (MB): 281"
#> [1] "Row number read: 832"
#> [1] "Cache memory in use (MB): 281"
#> [1] "Row number read: 896"
#> [1] "Cache memory in use (MB): 321"
#> [1] "Row number read: 960"
#> [1] "Cache memory in use (MB): 321"
#> [1] "Row number read: 1024"
#> [1] "Cache memory in use (MB): 362"
#> [1] "Row number read: 1088"
#> [1] "Cache memory in use (MB): 362"
#> [1] "Row number read: 1152"
#> [1] "Cache memory in use (MB): 401"
#> [1] "Row number read: 1216"
#> [1] "Cache memory in use (MB): 401"
#> [1] "Row number read: 1280"
#> [1] "Cache memory in use (MB): 401"
#> [1] "Row number read: 1344"
#> [1] "Cache memory in use (MB): 401"
#> [1] "Row number read: 1408"
#> [1] "Cache memory in use (MB): 401"
#> [1] "Row number read: 1472"
#> [1] "Cache memory in use (MB): 401"
```
...
```
## in MB
gdalraster::set_config_option("GDAL_CACHEMAX", "800")

## or percent of usable physical RAM
gdalraster::set_config_option("GDAL_CACHEMAX", "10%")
```
