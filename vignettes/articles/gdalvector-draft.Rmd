...
class GDALVector {
	...
	GIntBig createFeature(Rcpp::List feat);  // int64 handling TBD
...
* the return value of `GDALVector::createFeature()` should be the FID of the newly created feature upon successful write, or `-1` on failure; note that the other write methods currently have no return value, but this should possibly change (2024-03-02)
* add note above `class GDALVector` re: handling of 64-bit integer types to be determined (2024-03-02)
