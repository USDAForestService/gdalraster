...
**Note**: This document is now out of date and retained only as a record of the original proposed interface and initial development. Bindings to the GDAL Vector API were added in the **gdalraster** [2.0.0 release](https://github.com/USDAForestService/gdalraster/releases/tag/v.2.0.0). For current specifications, see the package vignette [Vector API Overview](https://usdaforestservice.github.io/gdalraster/articles/vector-api-overview.html) and the documentation for class [`GDALVector`](https://usdaforestservice.github.io/gdalraster/reference/GDALVector-class.html).
...
* existing utility functions for managing vector data sources (as of **gdalraster** 1.11.0): [ogr_manage](https://usdaforestservice.github.io/gdalraster/reference/ogr_manage.html) and [ogr_define](https://usdaforestservice.github.io/gdalraster/reference/ogr_define.html)
...
* [ogr_manage](https://usdaforestservice.github.io/gdalraster/reference/ogr_manage.html) and [ogr_define](https://usdaforestservice.github.io/gdalraster/reference/ogr_define.html) added in **gdalraster** dev; examples updated (2024-05-14)
