...
* new additional geometry functions operating on WKT (GEOS via GDAL headers): `bbox_transform()`, `g_is_empt()`, `g_is_valid()`, `g_intersects()`, `g_equals()`, `g_disjoint()`, `g_touches()`, `g_contains()`, `g_within()`, `g_crosses()`,`g_overlaps()`, `g_intersection()`, `g_union()`, `g_difference()`, `g_sym_difference()`, `g_distance()`, `g_length()`, `g_area()`, `g_centroid()` (2024-03-20)
