...
Installing from source on Windows requires [RTools](https://cran.r-project.org/bin/windows/Rtools/). RTools includes recent versions of the geospatial libraries needed to compile `gdalraster` (GDAL, GEOS, PROJ).
