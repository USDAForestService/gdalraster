...
The releases in ubuntugis-unstable generally work well and are more up-to-date, but the less recent versions in [ubuntugis-stable](https://launchpad.net/~ubuntugis/+archive/ubuntu/ppa) could be used instead.
...
[RTools](https://cran.r-project.org/bin/windows/Rtools/) is needed to install from source on Windows. RTools since version 4.2 includes GDAL, PROJ and all other dependent libraries that are needed to compile **gdalraster**. Note that CRAN releases periodic revisions to RTools that often include updates to the libraries as new versions become available. For example, the [5863 revision](https://cran.r-project.org/bin/windows/Rtools/rtools43/news.html) of RTools 4.3 contains GDAL 3.7.2 and PROJ 9.3.0.
