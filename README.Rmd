...
**gdalraster** includes thorough [documentation](#documentation) that is frequently cross-linked to source documentation provided by the GDAL project. It should be useful in applications that need low-level raster I/O or prefer a direct GDAL API. The additional functionality is somewhat aimed at thematic data analysis but may have other utility.
